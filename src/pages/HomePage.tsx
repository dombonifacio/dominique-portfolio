...
const HomePage = () => {
  ...
  return (
    <>
      <div className="hidden xl:top-[70%] xl:fixed xl:h-[100vh]  xl:px-4 xl:flex xl:flex-col items-center gap-y-2 ">
        <ul className="flex flex-col gap-y-3">
          {/* LinkedIn */}
          <li className="p-3 shadow-[3px_5px_0px_0px_rgbargba(11,21,35,1))] bg-gray-800 rounded-full hover:bg-slate-700 duration-75">
            <a href="https://www.linkedin.com/in/dominique-bonifacio/">
              <svg
                width="34"
                viewBox="0 0 16 16"
          ...
          <li className=" p-3 shadow-[3px_5px_0px_0px_rgbargba(11,21,35,1))] bg-gray-800 rounded-full hover:bg-slate-700 duration-75">
            <a href="https://github.com/dombonifacio">
              <svg
                width="34"
                viewBox="0 -0.5 24 24"
      ...
      <div className=" mx-auto relative max-w-[1000px]  ">
        ...
        <div className="h-screen p-6 ">
          <div className="flex justify-center items-center h-full text-center ">
            <div className="">
              ...
              {/* Social media buttons for mobile only */}
            </div>
          </div>
        </div>
        ...
        <footer className="">
          <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <div className="flex justify-center gap-x-2 w-full xl:hidden">
              <a
                href="https://github.com/dombonifacio"
                className=" p-2 shadow-[3px_5px_0px_0px_rgbargba(11,21,35,1))] bg-gray-800 rounded-full hover:bg-slate-700 duration-75"
              >
                <svg
                  className="w-8 h-8"
              ...
              <a
                href="https://www.linkedin.com/in/dominique-bonifacio/"
                className=" p-2 shadow-[3px_5px_0px_0px_rgbargba(11,21,35,1))] bg-gray-800 rounded-full hover:bg-slate-700 duration-75"
              >
                <svg
                  className="w-8 h-8"
            ...
            <span className="my-6 block text-sm text-gray-500 sm:text-center dark:text-gray-400">
